...
**  django initialize
    ...
    $ python manage.py makemigrations Coop # if edited models
    $ python manage.py syncdb
    $ python manage.py migrate
    
    [[file:~/work/mysite/mysite/settings.py]]
    [2015-10-31 Sat 04:47]
** sato homepage 作業記録
- pip install pytz
...
** DONE [#C] generate test code for python
use imenu or py:
    
    [[file:/usr/lib/python2.7/dist-packages/wx-2.8-gtk2-unicode/wx/_core.py]]
** TODO safe save-buffer find-file
  <2015-10-14 Wed 22:43>
** TODO managing keybind for emacs
  <2015-10-14 Wed 12:22>
** TODO database を多重化
  <2015-10-12 Mon 20:55>
** TODO create emacs keybind utility package
  <2015-10-12 Mon 10:22>
** TODO Create king server clone on VirtualBox
  <2015-10-07 Wed 09:04>
** TODO coop mysql
  <2015-10-06 Tue 14:02>
** DONE magit perspective
...
** DONE org-todo rotate sequence TODO => DONE => LATER
...
5) 結果
6) time/ref
    / cf. [[file:~/.emacs.d/allinone.org::*safe%20kill-emacs%20save-buffer%20find-file][safe kill-emacs save-buffer find-file]]
   
   [2015-10-21 Wed 14:32]
** TODO [#C] Fix auto-save location
...
5) 結果
6) time/ref
    / cf. [[file:~/.emacs.d/inits/11-auto-save-setup.el::%3B%3B%20(add-to-list%20'auto-save-file-name-transforms][file:~/.emacs.d/inits/11-auto-save-setup.el::;; (add-to-list 'auto-save-file-name-transforms]]
   
   [2015-10-28 Wed 06:40]
** TODO [#C] Fix xahk change window 

1) 背景(問題点)
   Failed keybind if changed window by alt-tab.
...
5) 結果
6) time/ref
    / cf. [[file:~/.emacs.d/site-lisp/mylisps/settings/face-setup.el::%3B%3B%20(set%20font-lock-support-mode%20'fast-lock-mode)][file:~/.emacs.d/site-lisp/mylisps/settings/face-setup.el::;; (set font-lock-support-mode 'fast-lock-mode)]]
   
   [2015-11-11 Wed 09:51]
* DOING:
** TODO [#C] mark-expand bind to C-SPC
...
5) 結果
6) time/ref
    / cf. [[file:~/.pylib/daily2/exe/create_recipe.py::window.add_observer(self)]]
   
   [2015-10-23 Fri 14:14]
* Emacs:
** TODO code reading
...
6) time/ref
    / cf.
** TODO [#C] show weekly past recipes
...
5) 結果
6) time/ref
    / cf. [[file:~/.pylib/diary/database_client.py::"""]]
   
   [2015-10-23 Fri 16:29]
** TODO [#C] __python__ py:= failed in function 

1) 背景(問題点)
   ! is pointer.
   mkdir(parents!) => mkdir(parents == )
   I expect to mkdir(parents=)
...
5) 結果
6) time/ref
    / cf. [[file:~/.pylib/recipe/coop/cache_request.py]]
   
   [2015-10-25 Sun 01:49]
* assembly:
* C C++:
** code_reading
*** code reading
...
** 風変わりな解決策
   - Adapter によるインターフェースの統合
* Lisp:
** TODO [#C] upcase-region if region active
...
5) 結果
6) time/ref
    / cf. [[file:~/.emacs.d/inits/02-t1-bind-key-setup.el::("w"%20.%20query-replace)][file:~/.emacs.d/inits/02-t1-bind-key-setup.el::("w" . query-replace)]]
   
   [2015-10-25 Sun 22:10]
