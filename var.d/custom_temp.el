...
(custom-set-variables
 ...
 '(browse-url-browser-function (quote w3m-browse-url-new-tab))
 ...
 '(flycheck-disabled-checkers (quote (python-flake8 python-pycompile)))
 '(flycheck-display-errors-delay 1.5)
 '(flycheck-display-errors-function (function flycheck-display-error-messages2))
 '(flycheck-highlighting-mode (quote lines))
 '(flycheck-idle-change-delay 1.0)
 '(flycheck-pylintrc (expand-file-name ".pylint" (my-data-dir-get)))
 '(garbage-collection-messages nil)
 '(gc-cons-threshold (* gc-cons-threshold 25))
 ...
 '(helm-mini-default-sources
   (quote
    (helm-source-buffers-list helm-source-bookmarks helm-source-recentf helm-source-find-files helm-source-buffer-not-found)))
 ...
 '(multi-term-scroll-to-bottom-on-output (quote all))
 '(next-screen-context-lines 3)
 '(open-junk-file-directory
   (expand-file-name "%Y-%m-%d-%H%M%S.junk." open-junk-file-dir-path) t)
 ...
 '(org-todo-keywords (quote ("TODO" "DONE" "WAIT" "POSTPONES")))
 '(overflow-newline-into-fringe t)
 '(package-selected-packages
   (quote
    (smartparens w3m virtualenv viewer use-package usage-memo undo-tree unbound tabbar systemd syslog-mode sudo-ext smartrep smart-operator sequential-command scratch-log scratch-ext savekill save-sexp revive recentf-ext quickrun pylint point-undo point-stack open-junk-file noflet multiple-cursors multi-term mark-multiple magit log4j-mode linum-off jedi init-loader info+ ht helm-pydoc helm-ls-git helm-c-yasnippet header2 grep-a-lot google-this fuzzy frame-cmds fold-dwim-org flymake-cursor flycheck f expand-region esup edit-list e2wm-term dsvn dired+ cython-mode csv-mode crosshairs crontab-mode column-marker color-moccur c-eldoc auto-yasnippet auto-install auto-highlight-symbol auto-complete-clang auto-complete-c-headers auto-async-byte-compile ascii apache-mode ahk-mode)))
 ...
 '(yas-prompt-functions (quote (yas-popup-isearch-prompt yas-no-prompt)))
 '(yas-root-directory (my-data-dir-join "snippets/"))
 '(yas-snippet-dirs (list (my-data-dir-join "snippets/")) nil (yasnippet))
...
(custom-set-faces
 ...
 '(custom-button-face ((t (nil))) t)
 '(custom-changed-face ((t (:background "blue" :foreground "white"))) t)
 '(custom-documentation-face ((t (nil))) t)
 '(custom-face-tag-face ((t (:underline t))) t)
 '(custom-group-tag-face ((t (:underline t :foreground "light blue"))) t)
 '(custom-group-tag-face-1 ((t (:underline t :foreground "pink"))) t)
 ...
 '(custom-variable-button-face ((t (:underline t :bold t))) t)
 '(custom-variable-tag-face ((t (:underline t :foreground "light blue"))) t)
 ...
 '(helm-M-x-key ((((class color) (background dark)) :foreground "orange")))
 '(helm-buffer-directory ((t :inherit my-directory-face)))
 '(helm-buffer-file ((t :inherit my-file-name-face)))
 '(helm-buffer-not-saved ((((class color) (background dark)) :foreground "yellow")))
 '(helm-ff-directory ((t :inherit my-directory-face)))
 '(helm-ff-dotted-directory ((((class color) (background dark)) :foreground "gray")))
 '(helm-ff-dotted-symlink-directory ((((class color) (background dark)) :foreground "#8b0000")))
 '(helm-ff-executable ((((class color) (background dark)) :foreground "red")))
 ...
 '(helm-ff-symlink ((((class color) (background dark)) :inherit my-symlink-face)))
 '(helm-grep-match ((((class color) (background dark)) :foreground "red")))
 '(helm-history-deleted ((((class color) (background dark)) :foreground "gray")))
 '(helm-history-remote ((((class color) (background dark)) :foreground "cyan" :underline t)))
 '(helm-match ((((class color) (background dark)) :inherit match)))
 '(helm-match-item ((((class color) (background dark)) :foreground "red")))
 '(helm-selection ((((class color) (background dark)) :inherit match)))
 '(helm-selection-line ((((class color) (background dark)) :foreground "red")))
 '(helm-source-header ((((background dark)) :background "#511a1a" :foreground "white" :weight bold :height 1.1 :family "Sans Serif") (((background light)) :background "#abd7f0" :foreground "black" :weight bold :height 1.1 :family "Sans Serif")))
 ...
 '(italic ((t (:italic t))))
 '(mouse-color ((((class color) (background dark)) (:background "white")) (t nil)))
 ...
 '(tabbar-default ((((class color) (background dark)) :background "gray25" :foreground nil :height 1.0)))
 '(tabbar-modified ((((class color) (background dark)) :background nil :foreground "yellow" :box nil :bold t)))
 '(tabbar-selected ((((class color) (background dark)) :background nil :foreground "red" :box nil :bold t)))
 '(tabbar-unselected ((((class color) (background dark)) :background nil :foreground "green" :box nil)))
 '(underline ((t (:underline t))))
 '(widget-button (quote ((t (:bold t)))))
