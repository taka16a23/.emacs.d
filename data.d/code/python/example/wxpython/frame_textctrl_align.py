...
if __name__ == '__main__':
    ...
    text1 = wx.TextCtrl(panel, wx.ID_ANY, 'left', style=wx.TE_LEFT)
    text2 = wx.TextCtrl(panel, wx.ID_ANY, 'center', style=wx.TE_CENTER)
    text3 = wx.TextCtrl(panel, wx.ID_ANY, 'right', style=wx.TE_RIGHT)
