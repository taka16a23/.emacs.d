;;; message_plugin_start.el --- functions for message
;;
...
;; Last-Updated: Thu Dec 13 22:48:37 2012 (+0900)
;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;
...
;;;###autoload
(defun message-predefine ()
  "For `eval-after-load' message function."
  (message "Loading message..")
  (message-faces-predefine))

;;;###autoload
(defun message-faces-predefine ()
  "For message faces."
  (interactive)
  ...
  (face-spec-set 'message-header-newsgroups-face '((t (:bold t :foreground "violet"))))
  ...
  (face-spec-set 'message-header-xheader-face    '((t (:bold t :foreground "light blue"))))
  (face-spec-set 'message-mml-face               '((t (:bold t :background "Green3"))))
  (face-spec-set 'message-separator-face         '((t (:foreground "blue3"))))
  )


(provide 'message_plugin_start)
;; For Emacs
;; Local Variables:
;; coding: utf-8
;; End:
;;; message_plugin_start.el ends here
