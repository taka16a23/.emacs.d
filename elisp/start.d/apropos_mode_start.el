;;; apropos_mode_start.el --- functions for apropos
;;
...
;; Maintainer:   Atami
;; Version:      1.0
;; Created:      Mon Dec 10 17:13:49 2012 (+0900)
;; Last-Updated: 2013/11/02 16:04:29 (+0900)
;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;
...
(eval-when-compile
  ...
  (require 'apropos "apropos" 'noerr))


;;;###autoload
(defun apropos-mode-custom-predefine ()
  "For `eval-after-load' apropos customize."
  (message "eval-after-load: \"apropos\" customizing..")
  ;; (custom-set-variables
  ;; '())
  )

;;;###autoload
(defun apropos-mode-predefine ()
  "For `eval-after-load' apropos function."
  (message "eval-after-load: \"apropos\" setting..")
  )

;;;###autoload
(defun apropos-mode-map-predefine ()
  "For apropos key bindings."
  (interactive)
  (unless (called-interactively-p 'interactive)
    (message "eval-after-load: \"apropos\" keymaping.."))
  (default-view-bind-set apropos-mode-map))

;;;###autoload
(defun apropos-mode-face-predefine ()
  "For apropos face."
  (message "eval-after-load: \"apropos\" Setting faces..")
  )
...

(provide 'apropos_mode_start)
;; For Emacs
;; Local Variables:
;; coding: utf-8
;; End:
;;; apropos_mode_start.el ends here
